...
class Game:
    ...
    def createRooms(self):
        ...
        # llave = Mision('mision', 'Esto es una mision',0)
    ...
    def printHelp(self):
        ...
        print("   go | quit | help | look | bag | back | take | drop  | eat")
        print()
        ...
        #print("* drop: permite al jugador dejar/soltar un item y dejarlo en la habitación")
    ...
    def activateTransportador(self, command):
        ...
        if(not command.hasSecondWord()):
            print("activate what?")
            print("Hey Dog. I don't know whath you want to activate. You must tell me that!!!")
    ...
    def openTransportador(self, command):
        if(not command.hasSecondWord()):
            print("Open what?")
            print("Hey Dog. I don't know whath you want to open. You must tell me that!!!")
